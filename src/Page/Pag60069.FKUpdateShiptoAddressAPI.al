page 60069 "FK Update Ship to Address API"
{
    ...
    begin
        FKFunc.APITempToTable(Database::"Ship-to Address", page::"FK Ship to Address API", Rec, rec."Customer No." + ' : ' + rec.Code, 1, 'SHIP TO ADDRESS', gvJsonObject);
        if ltShiptoAddress.GET(rec."Customer No.", rec.Code) then
            rec.TransferFields(ltShiptoAddress, false);
    end;
