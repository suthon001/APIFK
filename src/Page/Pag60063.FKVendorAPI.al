page 60063 "FK Vendor API"
{
    ...
    Caption = 'Vendor API';
    DelayedInsert = true;
    EntityName = 'createvendor';
    EntitySetName = 'createvendors';
    PageType = API;
    ...
    begin
        FKFunc.APITempToTable(Database::vendor, page::"FK Vendor API", Rec, rec."No.", 0, 'VENDOR', gvJsonObject);
    end;
